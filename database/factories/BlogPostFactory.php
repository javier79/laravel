...
$factory->state(App\BlogPost::class, 'new-title', function (Faker $faker){
    return [
     'title' => 'New title',
     /*COMMENTED AS IN TUTORIAL'content' => 'Content of the blog post'// Commented to demonstrate how the factory then generates dumy data when there is not a directive like this to overwrite factory
