...
{{-- This block of code(up and below) is commented or eliminated due it's repeated
...
{{-- When home page displays and layout extends to it, the contents of @section('content')/@endsection
